...
module.exports = {
  key: 'search_with_async_read',
  noun: 'Full Resource Async',

  display: {
    label: 'Full Resource Async Search',
    description: 'A Search with just a _search and a _read_resource that has an async z.request.',
    important: true,
  },
